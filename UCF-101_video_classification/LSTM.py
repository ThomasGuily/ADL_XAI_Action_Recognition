...
history = model.fit(x = X_train, y = y_train, epochs=15, batch_size = 4 , shuffle=True, validation_split=0.4, callbacks=[checkpoint], verbose=2)
...
files_list = os.listdir("./video_data/ApplyEyeMakeup")

for k in os.listdir(data_dir):
 for i in files_list:
  print(i)
  for j in range(seq_len):
   print(print(y_pred[j]))
 files_list = os.listdir("./video_data/BenchPress")
